...
export class AuthService {
    ...
    public static async comparePassword(password: string, hashded: string): Promise<boolean> {
    ...
    public static decode(token: string): Token {
        return jwt.verify(token, "YtVHUFXjBtCdUtp3OOGtF8h_ogr_ZoT73pI76HxxylQ") as Token
    }
}